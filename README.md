About pysot-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysot-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/dme65/pySOT

Documentation: http://http://pysot.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3249&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysot-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysot` can be installed with `conda`:
...
It is possible to list all of the versions of `pysot` available on your platform with `conda`:
...
```
mamba search pysot --channel conda-forge
```
...
mamba repoquery search pysot --channel conda-forge

# List packages depending on `pysot`:
mamba repoquery whoneeds pysot --channel conda-forge

# List dependencies of `pysot`:
mamba repoquery depends pysot --channel conda-forge
```
